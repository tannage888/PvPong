...
class PongBall(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        surface_size = (self.pongball_radius * 2, self.pongball_radius * 2)
        self.surface = pygame.Surface(surface_size, pygame.SRCALPHA).convert_alpha()
        
        # Draw the circle on its surface. The background of this surface is transparent.
        pygame.draw.circle(self.surface, (255,255,255)), (self.pongball_radius, self.pongball_radius), self.pongball_radius)
